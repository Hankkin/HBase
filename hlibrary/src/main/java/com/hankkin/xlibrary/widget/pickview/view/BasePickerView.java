package com.hankkin.xlibrary.widget.pickview.view;
...
import com.hankkin.xlibrary.widget.pickview.listener.OnDismissListener;
import com.hankkin.xlibrary.widget.pickview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(com.bigkoo.pickerview.R.layout.layout_basepickerview, null, false);
            //设置界面的背景为透明
            dialogView.setBackgroundColor(Color.TRANSPARENT);
            //这个是真正要加载时间选取器的父布局
            contentContainer = (ViewGroup) dialogView.findViewById(com.bigkoo.pickerview.R.id.content_container);
            //设置对话框 左右间距屏幕30
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(com.bigkoo.pickerview.R.layout.layout_basepickerview, decorView, false);
    ...
    protected BasePickerView setOutSideCancelable(boolean isCancelable) {
        if (rootView != null) {
            View view = rootView.findViewById(com.bigkoo.pickerview.R.id.outmost_container);
