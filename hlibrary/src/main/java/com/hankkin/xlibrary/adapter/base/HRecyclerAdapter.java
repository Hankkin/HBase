...
public abstract class HRecyclerAdapter<T, V extends RecyclerView.ViewHolder> extends  RecyclerView.Adapter<V>{
    protected Context context;
    protected List<T> data = new ArrayList<T>();
    private ListItemCallBack itemCallback;

    public HRecyclerAdapter(Context context) {
        this.context = context;
    }

    public HRecyclerAdapter(Context context, ListItemCallBack<T> callback) {
        this.context = context;
        this.itemCallback = callback;
    }

    public HRecyclerAdapter(Context context, List<T> data) {
        this.context = context;
        this.data.clear();
        this.data.addAll(data);
    }

    public HRecyclerAdapter(Context context, List<T> data, ListItemCallBack<T> callback) {
        this.context = context;
        this.data.clear();
        this.data.addAll(data);
        this.itemCallback = callback;
